...
function autoHeaders(e, t) {
  var u, r, f, o, p, d, y;
  void 0 !== getAutoHeadersOptions(autoHeaderOptions) &&
    ((u = null),
    ...
    e.doneEach(function () {
      ...
      if (null === u)
        return d
          ? console.error('ERROR: the "start" number is empty or null')
          : "";
      if (u.every(isNaN))
        return d
      ...
      if (
        ...
        return d
          ...
          : "";
      var r,
        o = [0, u[0] - 1, u[1] - 1, u[2] - 1, u[3] - 1, u[4] - 1, u[5] - 1],
        n = [!0, !0, !0, !0, !0, !0, !0];
      for (r in t) {
        var a = t[r],
          s = "",

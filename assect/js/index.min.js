window.$docsify.plugins = [].concat((e, o) => {
  let t = {
    siteFont: "Microsoft YaHei",
    defaultTheme: "dark",
    codeFontFamily: "Microsoft YaHei, Roboto Mono, Monaco, courier, monospace",
    bodyFontSize: "16px",
    dark: {
      accent: "#42b983",
    ...
    light: {
      ...
      blockQuoteColor: "#858585",
      highlightColor: "#d22778",
      sidebarSublink: "#16232C",
      codeTypeColor: "#3F3F3F",
      coverBackground:
        "linear-gradient(to left bottom, hsl(118, 100%, 85%) 0%,hsl(181, 100%, 85%) 100%)",
      toogleImage:

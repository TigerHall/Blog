...
![DSDP计划截图](./IODP/DSDP计划.jpg?center)

科学海洋钻探的下一阶段，即深海钻探项目 (DSDP 1966-1983)，于 1966 年开始使用钻井船 [Glomar Challenger](http://www.iodp.tamu.edu/publicinfo/glomar_challenger.html) 。
...
| ANZIC       | Australia-New Zealand IODP Consortium                                                                      | 澳大利亚-新西兰-IODP联盟                     |
...
| EFB         | ECORD Facility Board                                                                                       | ECORD设施委员会                          |
...
| JR          | JOIDES Resolution                                                                                          | JOIDES分辨率                           |
| JRFB        | JOIDES Resolution Facility Board                                                                           | JOIDES决议机构委员会                       |
| JRSO        | JOIDES Resolution Science Operator                                                                         | JOIDES解析科学操作员                       |
...
| SEG-Y       | Seismic data (designated Y) file in the Society for Exploration Geophysicists' (SEG) "standardized" format | 勘探地球物理学家协会(SEG)“标准化”格式的地震数据（指定为Y）文件 |

...
从图3、图4中可以明显发现印度洋离轴区域的数据点Dupal特征更明显，很难不让人不联想到两者的离轴部分数据点与洋中脊部分的关系。

![图5 印度洋Δ7/4平面图-自然底图](./Dupal/ydy74.jpg "图5 印度洋Δ7/4平面图-自然底图")

> 图中白色小点为Δ7/4低于4的数据点；橙色为Δ7/4高于4小于10的、有明显Dupal特征的点；紫色和黑色为Δ7/4大于10的数据点，Dupal特征非常明显。
> 图中可以看出，沿着洋脊的主要是Δ7/4在4到10的数据点，部分区域小于4，所以可以根据图中的数据分布情况画出Dupal区域范围。
> 而离轴部分的数据点则普遍为Δ7/4大于10的，Dupal特征十分明显。可以看出，在印度洋的西部，东部，南部大致可见三部分的高Dupal特征点群。显然这三部分和洋中脊的状况又有所不同。

结合图3、图4、图5来看，基本上可以圈定北纬10°，东经25°，东经125°三个边界，并包含三部分离轴区域的印度洋Dupal特征区。

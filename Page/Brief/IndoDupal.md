...
一直以来，作为地幔不均一力证的Dupal异常的范围都没有确定下来。而印度洋作为最初发现Dupal特征的地方，显然是最适合圈定其范围的研究区。所以本文主要通过对印度洋洋中脊及洋壳部分的铅同位素数据进行分析处理，确定了Dupal异常的边界点，从而限制出Dupal特征的异常范围。在此基础上，通过前人对LLSVP，地幔柱的研究，探讨了Dupal与其影响因素的关系。最终确定印度洋Dupal异常区主要与核幔边界和被印度板块岩石圈污染的地幔两者有关，并对应印度洋Dupal特征区的两类特征区域。

...
地幔中岩浆以柱状上升至地表形成热点，印度洋区域的热点有不少，其中最引人注目的是马里昂（Marion）、凯尔盖朗（Kerguelen）和留尼汪（Réunion）热点。刚好凯尔盖朗和留尼汪热点两者都在离轴高Dupal特征区范围，需要结合板块运动和热点的动态关系来考虑热点的影响。

我们都知道， **印度构造板块的快速漂移造** 就了现今印度洋的模样。其中印度板块底侵熔融的陆壳部分自然也会影响到地幔，特别如东经90度海岭的存在，应该受印度板块影响很大。前人对印度洋板块和Dupal异常来源做过研究，不同于最初Hart猜测Dupal异常来源于下地幔，目前有不少联系起壳幔边界的特征区域和Dupal特征区的关系。

就比如**温联星**认为南大西洋到印度洋的地幔底有VLVP（A rapidly structurally-varying very-low velocity province）区域存在，以运动的方式判断出Dupal特征来自于VLVP上的三个热点。但是这不能合理的解释洋中脊的Dupal特征，以及没有热点影响的区域的Dupal特征是为什么。
